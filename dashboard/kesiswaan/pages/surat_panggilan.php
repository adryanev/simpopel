                        ...
                        <table id="datatable-responsive" class="table table-hover table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                            ...
                            if (mysqli_num_rows($result) > 0) {
                                while($row = mysqli_fetch_assoc($result)) {
                                   ...
                                   <a href=\"".$url."dashboard/processes/update_surat_panggilan.php?id=".$row['idSP']."\"> <button id='kepsek' type=\"button\" class=\"btn btn-success btn-xs\"><i class=\"fa fa-thumbs-up\"></i></button></a>
                                </td>";
                                    }
                                    if($row['statusWaka'] == 'ok'){
                                        ...
                                        echo "<td align=\"center\">
                                  <a href=\"".$url."dashboard/processes/update_surat_panggilan.php?id=".$row['idSP']."\">  <button id='wakil' type=\"button\" class=\"btn btn-success btn-xs\"><i class=\"fa fa-thumbs-up\"></i></button></a>
                                </td>";
                                    }
                                    if($row['statusKepsek'] == 'ok' && $row['statusWaka'] == 'ok'){
                                        echo "<td align=\"center\">
                                  <a href=\"".$url."dashboard/processes/print_sp.php?id=".$row['idSP']."\">  <button type=\"button\" class=\"btn btn-primary btn-xs\"><i class=\"fa fa-print\"></i></button></a>
                                </td>";
                                    }
                                    else{
                                        echo "<td align=\"center\">
