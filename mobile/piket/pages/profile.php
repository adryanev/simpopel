...
WHERE tabelsiswa.idSiswa = ". "$id";
                              ...
                              if(mysqli_num_rows($result)>0){
                                  ...
                                  $checkSP = mysqli_fetch_assoc(mysqli_query($dbConnection,"Select statusKepsek, statusWaka from tabelsp where idSiswa = $id"));
                                  if($checkSP['statusKepsek'] == 'ok' && $checkSP['statusWaka'] =='ok'){
                                      echo 'SP sudah diminta.';
                                  }
