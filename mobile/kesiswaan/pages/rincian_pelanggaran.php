                ...
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <div class="col-md-3 col-sm-3 col-xs-12 profile_left">
                            ...
                            <?php
                            include '../modals/edit_pelanggaran.php';
                            ?>

                            <button type="button" class="btn btn-success" data-toggle="modal" data-target=".bs-example-modal-lg"><i class="fa fa-edit m-right-xs"></i> Edit Pelanggaran</button>
                        </div>
